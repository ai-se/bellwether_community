...
class bellwether(object):
    def __init__(self,data_source):
        ...
        self.selected_projects = self.selected_projects
    ...
    def run_bellwether(self):
        ...
        with open('data/1385/633/1385_LR_default_bellwether_320.pkl', 'wb') as handle:
            pickle.dump(final_score, handle, protocol=pickle.HIGHEST_PROTOCOL)
        df = pd.read_pickle('data/1385/633/1385_LR_default_bellwether_320.pkl')
        results_f1 = {}
        results_precision = {}
        results_recall = {}
        results_g = {}
        ...
        results_f1_df.to_csv('data/1385/633/1385_LR_bellwether_f1.csv')
        results_precision_df.to_csv('data/1385/633/1385_LR_bellwether_precision.csv')
        results_recall_df.to_csv('data/1385/633/1385_LR_bellwether_recall.csv')
        results_g_df.to_csv('data/1385/633/1385_LR_bellwether_g.csv')
        results_d2h_df.to_csv('data/1385/633/1385_LR_bellwether_d2h.csv')
        results_pci_20_df.to_csv('data/1385/633/1385_LR_bellwether_pci_20.csv')
        results_ifa_df.to_csv('data/1385/633/1385_LR_bellwether_ifa.csv')
        results_pd_df.to_csv('data/1385/633/1385_LR_bellwether_pd.csv')
        results_pf_df.to_csv('data/1385/633/1385_LR_bellwether_pf.csv')
