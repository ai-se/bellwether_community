...
class bellwether(object):
    ...
    def run_bellwether(self,projects):
        ...
        for i in range(self.cores):
            ...
            t = ThreadWithReturnValue(target = self.bellwether, args = [split_projects[i][0:1],projects])
            threads.append(t)
        for th in threads:
            th.start()
        for th in threads:
